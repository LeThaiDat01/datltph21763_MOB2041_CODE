...
public class PhieuMuonDAO {
    ...
    public int update(PhieuMuon pm) {
        ...
        values.put("tienThue", pm.getTienThue());
        values.put("traSach", pm.getTraSach());
        return db.update("PhieuMuon", values, "maPM=?", new String[]{String.valueOf(pm.getMaPN())});
    }
    ...
    public List<PhieuMuon> getData(String sql, String... selectionArgs) {
        ...
        while (c.moveToNext()) {
            ...
            pm.setMaPN(Integer.parseInt(c.getString(c.getColumnIndex("maPM"))));
            ...
            try {
                pm.setNgay(sdf.parse(c.getString(c.getColumnIndex("ngay"))));
